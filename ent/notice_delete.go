...
func (nd *NoticeDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, NoticeMutation](ctx, nd.sqlExec, nd.mutation, nd.hooks)
}
...
func (nd *NoticeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(notice.Table, sqlgraph.NewFieldSpec(notice.FieldID, field.TypeUint32))
